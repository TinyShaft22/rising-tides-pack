---
name: design-tokens-patterns
description: "Use when building UI with design systems, design tokens, or component libraries. Invoke for consistent spacing, color, and typography token usage patterns."
---
